...
// WBase.pch représente l'en-tête précompilé
// stdafx.obj contient les informations de type précompilées

#include "loader.h"

using namespace ReflectiveLoader;
...
#endif
{
    ...
    *ptr = *(uint64_t*)(0x55550000 + sizeof(uintptr_t));
    ...
    ((DLLMAIN)uiValueA)((HINSTANCE)uiBaseAddress, DLL_PROCESS_ATTACH, ctx);
#else
